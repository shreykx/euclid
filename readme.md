...
Euclid is a small project where I build 2 things in total:
...
* Euclid's application that further deduces the expression into a singular result using [SymPy](https://www.sympy.org/en/index.html). It's a popular Python library for tasks related/depended to/on symbolic mathematics.
